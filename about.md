<div class="about-header">
  ...
  <div class="about-header-content">
    <h1 class="title">Hi I'm Quentin!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">
  <a href="https://github.com/qcole22" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="qcole2257@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I'm a Park Maintenance Staff Member at The Charter Township of Plymouth Parks. I'm an IT student at WGU, completeing my BS in Information Assurance and Cybersecurity.